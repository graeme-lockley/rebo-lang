...
pub fn write(machine: *Helper.Machine, calleeAST: *Helper.Expression, argsAST: []*Helper.Expression, args: []*Helper.Value) !void {
    ...
    const bytes = try Helper.getArgument(machine, calleeAST, argsAST, args, 1, &[_]Helper.ValueKind{Helper.ValueValue.StringKind});
