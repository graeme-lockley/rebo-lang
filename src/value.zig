...
pub const BuiltinFunctionType = *const fn (runtime: *Runtime, numberOfArguments: usize) Errors.RuntimeErrors!void;
...
pub const Value = struct {
    ...
    pub fn deinit(self: *Value, allocator: std.mem.Allocator) void {
        switch (self.v) {
            ...
            .CodeKind => self.v.CodeKind.decRef(allocator),
    ...
    pub fn appendValue(self: *const Value, buffer: *std.ArrayList(u8), style: Style) !void {
        switch (self.v) {
            ...
            .CodeKind => try std.fmt.format(buffer.writer(), "<code: {d}>", .{self.v.CodeKind.code.len}),
...
pub fn eq(a: *Value, b: *Value) bool {
    ...
    switch (a.v) {
        ...
        .CodeKind => return a.v.CodeKind == b.v.CodeKind,
